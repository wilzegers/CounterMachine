...
namespace Constants
{
    ...
    namespace ErrorMessages
    {
        ...
        static constexpr ConstStr nonexistant_register      = "trying to access nonexistent register no. %1%.";
        static constexpr ConstStr instruction_out_of_range  = "trying to run nonexistent instruction no. %1%.";
